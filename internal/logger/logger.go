...
func Init(level slog.Level) {
	...
	slog.Info("Сообщения уровня INFO будут выведены")
	slog.Debug("Сообщения уровня DEBUG будут выведены")
	slog.Warn("Сообщения уровня WARN будут выведены")
	slog.Error("Сообщения уровня ERROR будут выведены")
	slog.Info("Логгер инициализирован", "уровень", level.String())
}
